...
class TestArithmetic(unittest.TestCase):
    def test_basic_operator(self):
        ...
        self.assertEqual(run_code('a = 1', False, False, False), Error(typ = "Runtime Error", value = "assign to non-existing variable"))
        self.assertEqual(run_code('a', False, False, False), Error(typ = "Runtime Error", value = "read from non-existing variable"))
